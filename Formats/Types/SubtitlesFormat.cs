...
namespace AHD.SM.Formats
{
    public abstract class SubtitlesFormat
    {
        ...
        /// <summary>
        /// Get the supported extensions for ths format, the extensions started with dot "."
        /// </summary>
        ...
        /// <summary>
        /// Get or set a value indecate wether this format is enabled or not, not effect anything, just a property.
        /// </summary>
        ...
        /// <returns>True if this file matchs this format otherwise false</returns>
        ...
        /// <summary>
        /// Save format as file att given path
        /// </summary>
        /// <param name="filePath">The file full path</param>
        ...
        //Events
        /// <summary>
        /// Event rised up when this format does a progress at loading operation
        /// </summary>
        public abstract event EventHandler<ProgressArgs> Progress;
        /// <summary>
        /// Event rised up when this format starts the load operation
        /// </summary>
        public abstract event EventHandler LoadStarted;
        /// <summary>
        /// Event rised up when this format finished the loading operation
        /// </summary>
        public abstract event EventHandler LoadFinished;
        /// <summary>
        /// Event rised up when this format starts the save operation
        /// </summary>
        public abstract event EventHandler SaveStarted;
        /// <summary>
        /// Event rised up when this format finished the saving operation
        /// </summary>
